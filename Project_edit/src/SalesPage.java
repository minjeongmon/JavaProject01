...
public class SalesPage {
	...
	private void initialize() {
		...
		dayLabel.setBounds(157, 189, 55, 15);
		dayLabel.setFont(new Font("맑은 고딕", Font.BOLD, 15));
		panel.add(dayLabel);

		JButton btnNewButton = new JButton("CLICK");
		btnNewButton.setBounds(436, 178, 100, 35);
		btnNewButton.setFont(new Font("맑은 고딕", Font.BOLD, 15));
		panel.add(btnNewButton);

		JDateChooser dateChooser = new JDateChooser();
		dateChooser.getCalendarButton().setFont(new Font("맑은 고딕", Font.BOLD, 14));
		dateChooser.setBounds(215, 185, 150, 25);
