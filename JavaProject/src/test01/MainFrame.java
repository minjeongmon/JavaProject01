...
public class MainFrame {
	...
	private void initialize() {
		...
		JButton kiosk_btn = new JButton("키오스크 페이지");
		kiosk_btn.setFont(new Font("맑은 고딕", Font.BOLD, 15));
		kiosk_btn.setBounds(90, 36, 200, 100);
		panel_3.add(kiosk_btn);

		JButton admin_btn = new JButton("관리자 페이지");
		admin_btn.setFont(new Font("나눔고딕", Font.BOLD, 15));
		admin_btn.setBounds(400, 36, 200, 100);
		panel_3.add(admin_btn);
		
		// 관리자페이지 버튼 누르면 관리자 페이지로 이동 하기 //
